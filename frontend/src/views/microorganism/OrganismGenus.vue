    ...
    <el-main>
      ...
      >
        <el-table-column
          ...
          :label="$t('OrganismGenus.column.OrganismType')"
          sortable="custom"
          width="150"
        />
        <el-table-column
          prop="Description"
          :label="$t('OrganismGenus.column.Description')"
        />
        <el-table-column
          fixed="right"
...
import OrganismGenusEditor from "./EditModal/OrganismGenusEditor.vue";
export default defineComponent({
  name: "OrganismGenusList",
  components: { OrganismGenusEditor },
  mixins: [ListMixin],
  data() {
    return {
      entityName: "OrganismGenus",
      ...
      query: {
        ...
        $select: "Id,OrganismTypeId,Description,IsActive",
      },
      editModel: {
        OrganismTypeId: undefined,
        Description: undefined,
